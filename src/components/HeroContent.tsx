...
const HeroContent = () => {
    return (
        <div className="w-full flex flex-col items-start gap-6">
            <h1 className="lg:text-8xl md:text-6xl text-4xl lg:*:leading-[6.5rem] font-semibold relative">
                We develop
                <svg
                ...
                <br />
                <span className="bg-gradient-to-l from-[var(--primary-color)] to-[var(--secondary-color)] bg-clip-text text-transparent">amazing</span> websites <br />
                for your business<span className="text-[var(--primary-color)]">.</span>
            </h1>
            <p className="lg:w-[55%] w-[85%] lg:text-base md:text-sm text-xs text-neutral-400">
            ...
            <div className="flex md:flex-row flex-col-reverse md:items-center items-start gap-5">
